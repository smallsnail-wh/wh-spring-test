...
public class Operation {
	 ...
	 * @param operators
	 */
	public static void operation(LinkedList<Double> stack, LinkedList<LinkedList<Double>> stacks, String inputString,
			String[] operators) {
		try {
			/* 输入流 */
	 ...
	 * @return
	 */
	public static Double generalOperation(Double data1, Double data2, String operator) {
	 ...
	 * @return
	 */
	public static Double sqrtOperation(Double data1) {
